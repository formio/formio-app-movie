...
angular
  ...
  .config([
    ...
    'FormioProvider',
    'AppConfig',
    function ($stateProvider, $urlRouterProvider, FormioProvider, AppConfig) {
  ...
  .run([
    ...
    function(
      ...
      $rootScope.movieForm = AppConfig.appUrl + '/movie';
      $rootScope.directorForm = AppConfig.appUrl + '/director';
